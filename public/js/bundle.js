...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3N0eWxpYW5pZGVzIiwiYSI6ImNrNXNzbHA0azByYmszbW5uMDV5d2kwMzYifQ.8yA-uYosMDKii-7PmtJalQ';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Log Out Successful');
              window.setTimeout(function () {
                location.assign('/');
              }, 100);
            }
